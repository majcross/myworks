...
?>
		...
		<div class="row content">
			<div class="col-sm-3 sidenav">
					...
					<ul class="nav nav-pills nav-stacked "><br>
						<li class="active"><a data-toggle="pill" href="#all">All Members</a></li>
						<li><a data-toggle="pill" href="#work" >Workers</a></li>
						<li><a href="">Members By Location</a></li>
						<li><a href="">Profession</a></li>
						<li><a data-toggle="pill" href="#sex">Members only</a></li>
					</ul><br>
				</div>
				<br>
	...
	<!-- this contains all the records of workers only to be display records filled in the membership form will on be reflected here  -->

	<div id="work" class="tab-pane fade">	
		<div class="col-sm-9">
					<div class="well">
						<h3>RCCG SOP</h3>
						<p>Contains all the details of the Workers.</p>
					</div>
	...
	<!-- this contains record of members by sex. -->
	<?php	
	$pdo_statement = $pdo_conn->prepare("SELECT * FROM churchtable ORDER BY gender ASC");
	$pdo_statement->execute();
	$result = $pdo_statement->fetchAll();
?>
	...
	<!-- this is the ending of the pill div -->
	</div>
	</div>
</div>
